document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = (input) => {
            ...
            const name = input.name || input.id || type;
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    successMessage.style.cssText = 'color: #28a745; margin-top: 1rem; font-weight: bold;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '56c78c32-c343-4bb8-944c-c3356cff8f96',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '56c78c32-c343-4bb8-944c-c3356cff8f96';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '56c78c32-c343-4bb8-944c-c3356cff8f96';
